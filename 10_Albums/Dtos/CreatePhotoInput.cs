...
public class CreatePhotoInput
{
    ...
    [StringLength(200, MinimumLength = 5, ErrorMessage = "TagsAr Must be between 5 and 200 characters")]
    public string TagsAr { get; set; }

    [Required(ErrorMessage = "TagsEn is required")]
    [StringLength(200, MinimumLength = 5, ErrorMessage = "TagsEn Must be between 5 and 200 characters")]
