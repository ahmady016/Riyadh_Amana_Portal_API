...
namespace amana_mono.__DB.Migrations
{
    ...
    [Migration("20220803213145_Add_Lookup_Entity")]
    partial class Add_Lookup_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DB.Entities.Lookup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DB.Entities.City", b =>
                {
                    b.HasBaseType("DB.Entities.Lookup");

                    b.HasDiscriminator().HasValue("city");
                });

            modelBuilder.Entity("DB.Entities.Nationality", b =>
                {
                    b.HasBaseType("DB.Entities.Lookup");
            ...
            modelBuilder.Entity("DB.Entities.Qualification", b =>
                {
                    b.HasBaseType("DB.Entities.Lookup");

                    b.HasDiscriminator().HasValue("qualification");
                });
