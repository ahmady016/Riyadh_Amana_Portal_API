...
{
    public partial class Add_Album_With_Photo_Entities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tags_ar = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    tags_en = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
