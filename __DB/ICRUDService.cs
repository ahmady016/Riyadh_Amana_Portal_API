...
public interface ICRUDService
{
    ...
    T Add<T, Tkey>(T item) where T : Entity<Tkey>;
    void AddRange<T, Tkey>(List<T> range) where T : Entity<Tkey>;
    List<T> AddAndGetRange<T, Tkey>(List<T> range) where T : Entity<Tkey>;
    ...
    void Activate<T, TKey>(T item) where T : Entity<TKey>;
    void ActivateRange<T, TKey>(List<T> range) where T : Entity<TKey>;
