...
public class CreateVideoInput
{
    ...
    [StringLength(500, MinimumLength = 10, ErrorMessage = "DescriptionAr must between 10 and 500 characters")]
    public string DescriptionAr { get; set; }

    [StringLength(500, MinimumLength = 10, ErrorMessage = "DescriptionEn must between 10 and 500 characters")]
