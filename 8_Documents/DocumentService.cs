...
namespace Documents
{
    public class DocumentService
    {
        ...
        {
            var document = _mapper.Map<List<Document>>(inputs);
            var createdDocument = _crudService.AddAndGetRange<Document, Guid>(document);
            _crudService.SaveChanges();
            return _mapper.Map<List<DocumentDto>>(createdDocument);
        }
        ...
        {
            var document = _mapper.Map<List<Document>>(inputs);
            var updatedDocument = _crudService.UpdateAndGetRange<Document, Guid>(document);
            _crudService.SaveChanges();
            return _mapper.Map<List<DocumentDto>>(updatedDocument);
        }
